...
error_reporting(0);
  ...
  if ($_SESSION['loggedin']) 
  {
         ...
         <nav class="col d-none d-md-block bg-light sidebar">
              <!-- <div class="sidebar-sticky"> -->
                <ul class="nav nav-tabs">
                  <li><h4 class="lead" style="padding: 7px;">Thesis batch-></h4></li>
                  
                    <?php 
                      while($fetch = mysqli_fetch_assoc($data)){
                         $temp = $fetch['batch'];/*store batch values in $temp variables */
                    ?>

                  <li class="nav-item">
                    <a class="nav-link" href="showThesisbyBatch.php?batch=<?php echo $temp ?>">
    ...
    <?php 
        ...
        echo'<div class="alert alert-light container lead"><h3 class="h3" >Thesis <h3></div>';
