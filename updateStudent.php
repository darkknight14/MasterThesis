<?php
  ...
  if ($_SESSION['loggedin']) 
  {
         ...
         <nav class="col d-none d-md-block bg-light sidebar">
              <div class="sidebar-sticky">
                <ul class="nav nav-tabs">
                  <li><h4 class="lead" style="padding: 7px;">Student batch-></h4></li>
                  <?php 
                    while($fetch = mysqli_fetch_assoc($data)){
              $temp = $fetch['batch'];
            ?>
                  <li class="nav-item">
                    <a class="nav-link " href="updateStudentbyBatch.php?batch=<?php echo $temp ?>">
    ...
    <?php 
        ...
        echo'<div class="alert alert-light container lead"><h3 class="h3" >Students <h3></div>';
